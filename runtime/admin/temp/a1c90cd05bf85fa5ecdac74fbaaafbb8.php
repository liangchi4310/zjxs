<?php /*a:4:{s:61:"D:\phpstudy_pro\WWW\zjxsh\app\admin\view\dashboard\index.html";i:1607568254;s:60:"D:\phpstudy_pro\WWW\zjxsh\app\admin\view\layout\default.html";i:1607568254;s:57:"D:\phpstudy_pro\WWW\zjxsh\app\admin\view\common\meta.html";i:1607568254;s:59:"D:\phpstudy_pro\WWW\zjxsh\app\admin\view\common\script.html";i:1607568254;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo htmlentities($totalviews); ?></span>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo htmlentities($totalorder); ?></span>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo htmlentities($totalorderamount); ?></span>
                            ...
                            <div class="card-block">
                                <div class="row row-sm stats-container">
                                    ...
                                    <div class="col-xs-6  stat-col">
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo htmlentities($todayorder); ?></div>
                                    ...
                                    <div class="col-xs-6  stat-col">
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo htmlentities($unsettleorder); ?></div>
                        ...
                        <div class="box box-info">
                            ...
                            <div class="box-body" style="padding-top:0;">
                                <table class="table table-striped">
                                    <tbody>
                                    <tr>
                                        <td width="140">主框架版本</td>
                                        <td><?php echo htmlentities(config('fastadmin.version')); ?>
                                            <a href="javascript:;" class="btn btn-xs btn-checkversion">检查最新版</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>插件版本</td>
                                        <td><?php echo htmlentities($addonversion); ?></td>
                                    </tr>
                                    <tr>
                                        <td>ThinkPHP版本</td>
                                    ...
                                    <tr>
                                        <td>调试模式</td>
                                        <td><?php echo app('request')->env('app_debug')?__('Yes'):__('No'); ?></td>
                                    </tr>
                                    <tr>
                                        <td>环境信息</td>
                                    ...
                                    <tr>
                                        <td>上传URL</td>
                                        <td><?php echo htmlentities($config['upload']['uploadurl']); ?></td>
                                    </tr>
                                    <tr>
                                        <td>上传CDN</td>
                                        <td><?php echo htmlentities($config['upload']['cdnurl']); ?></td>
                                    </tr>
                                    <tr>
                                        <td>时区</td>
                                    ...
                                    <tr>
                                        <td>语言</td>
                                        <td><?php echo htmlentities($config['language']); ?></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
