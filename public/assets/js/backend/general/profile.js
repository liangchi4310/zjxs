        ...
        index: function () {
            ...
            Table.api.init({
                ...
                extend: {
                    ...
                    "add_url": "general.profile/add",
                    "edit_url": "general.profile/edit",
                    "del_url": "general.profile/del",
                    "multi_url": "general.profile/multi",
                }
            });
        ...
        api: {
            formatter: {
                url: function (value, row, index) {
                    return '<div class="input-group input-group-sm" style="width:250px;"><input type="text" ' +
                        'class="form-control input-sm" value="' + value + '"><span class="input-group-btn input-group-sm">' +
                        '<a href="' + value + '" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-link"></i></a></span></div>';
                },
            },
        }
    };
